...
const musica = new Audio('https://github.com/marlonolivveira/fokus/blob/main/sons/luna-rise-part-one.mp3');
window.musica = musica;
musica.loop = true;
const play = new Audio('https://github.com/marlonolivveira/fokus/tree/main/sons/play.wav');
const pause = new Audio('https://github.com/marlonolivveira/fokus/tree/main/sons/pause.mp3');
const beep = new Audio('https://github.com/marlonolivveira/fokus/tree/main/sons/beep.mp3');
window.beep = beep;
